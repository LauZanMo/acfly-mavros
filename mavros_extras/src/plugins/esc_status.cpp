...
private:
    ...
    void handle_esc_info(const mavlink::mavlink_message_t *msg,
        ...
        for (int i = 0; i < std::min<ssize_t>(batch_size, ssize_t(_max_esc_count) - esc_index);
             i++) {
            ...
            _esc_info.esc_info[esc_index + i].temperature =
                esc_info.temperature[i] * 1E2; //!<  [degreesC]
        }
    ...
    void handle_esc_status(const mavlink::mavlink_message_t *msg,
