...
public:
    VisionPoseEstimatePlugin() : PluginBase(), sp_nh("~vision_pose"), tf_rate(10.0) {}
    ...
    void initialize(UAS &uas_) override {
        ...
        if (tf_listen) {
            ROS_INFO_STREAM_NAMED("vision_pose", "Listen to vision transform "
...
private:
    ...
    void send_vision_estimate(const ros::Time &stamp, const Eigen::Affine3d &tr,
        ...
        if (last_transform_stamp == stamp) {
            ROS_DEBUG_THROTTLE_NAMED(10, "vision_pose",
