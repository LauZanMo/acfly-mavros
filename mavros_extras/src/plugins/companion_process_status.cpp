...
public:
    CompanionProcessStatusPlugin() : PluginBase(), status_nh("~companion_process") {}
...
private:
    ...
    void status_cb(const mavros_msgs::CompanionProcessStatus::ConstPtr &req) {
        ...
        ROS_DEBUG_STREAM_NAMED("companion_process_status",
...
PLUGINLIB_EXPORT_CLASS(mavros::extra_plugins::CompanionProcessStatusPlugin,
