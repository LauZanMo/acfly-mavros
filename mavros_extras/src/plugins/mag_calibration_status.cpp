...
public:
    MagCalStatusPlugin() : PluginBase(), mcs_nh("~mag_calibration") {}
...
private:
    ...
    void handle_status(const mavlink::mavlink_message_t *,
    ...
    void handle_report(const mavlink::mavlink_message_t *,
