 ...
 *
 * Sends <a href="https://mavlink.io/en/messages/common.html#GPS_INPUT">GPS_INPUT MAVLink
 * messages</a>
 */
class GpsInputPlugin : public plugin::PluginBase {
public:
    GpsInputPlugin() : PluginBase(), gps_input_nh("~gps_input"), gps_rate(5.0) {}
...
private:
    ...
    void send_cb(const mavros_msgs::GPSINPUT::ConstPtr ros_msg) {
        ...
        /**
         * @note: <a href="https://mavlink.io/en/messages/common.html#GPS_INPUT">GPS_INPUT MAVLink
         * message</a> is currently only supported by Ardupilot firmware
         */
