...
public:
    ADSBPlugin() : PluginBase(), adsb_nh("~adsb") {}
...
private:
    ...
    void handle_adsb(const mavlink::mavlink_message_t   *msg,
        ...
        adsb_msg->header.stamp =
            ros::Time::now(); // TODO: request add time_boot_ms to msg definition
        // [[[cog:
        ...
        // TR_TAB = (
        // ent('ICAO_address'),
        // ent('callsign', to_ros='mavlink::to_string', to_mav='mavlink::set_string_z({mm}.{mav},
        // {rmp}->{ros})'), ent('latitude', 'lat', '1e7'), ent('longitude', 'lon', '1e7'),
