...
public:
    GpsStatusPlugin() : PluginBase(), gpsstatus_nh("~gpsstatus") {}
...
private:
    ...
    /**
     * @brief Publish <a href="https://mavlink.io/en/messages/common.html#GPS2_RAW">mavlink GPS2_RAW
    ...
    /**
     * @brief Publish <a href="https://mavlink.io/en/messages/common.html#GPS_RTK">mavlink GPS_RTK
    ...
    /**
     * @brief Publish <a href="https://mavlink.io/en/messages/common.html#GPS2_RTK">mavlink GPS2_RTK
    ...
    void handle_gps2_rtk(const mavlink::mavlink_message_t *msg,
        ...
        default:
            ROS_ERROR_NAMED("gps_status",
                            "GPS_RTK2.baseline_coords_type MAVLink field has unknown \"%d\" value",
                            mav_msg.baseline_coords_type);
        }
        ros_msg->header             = m_uas->synchronized_header(ros_msg->header.frame_id,
                                                     mav_msg.time_last_baseline_ms * 1000);
