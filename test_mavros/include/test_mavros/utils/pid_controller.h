...
public:
     ...
     */
    void setup_linvel_pid(double                 p_gain,
                          double                 i_gain,
                          double                 d_gain,
                          double                 i_max,
                          double                 i_min,
     ...
     */
    void setup_yawrate_pid(double                 p_gain,
                           double                 i_gain,
                           double                 d_gain,
                           double                 i_max,
                           double                 i_min,
     ...
     */
    Eigen::Vector3d
    compute_linvel_effort(Eigen::Vector3d goal, Eigen::Vector3d current, ros::Time last_time);
