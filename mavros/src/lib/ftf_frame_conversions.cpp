/**
 * @file ftf_frame_conversions.cpp
...
/**
 * @brief 3-D matrices to fill 6-D rotation matrix applied to change covariance matrices coordinate
 * frames
 */
...
Covariance9d transform_static_frame(const Covariance9d &cov, const StaticTF transform) {
    ...
    case StaticTF::AIRCRAFT_TO_BASELINK:
    case StaticTF::BASELINK_TO_AIRCRAFT:
        R.block<3, 3>(0, 0) = R.block<3, 3>(3, 3) = R.block<3, 3>(6, 6) = AIRCRAFT_BASELINK_R;
