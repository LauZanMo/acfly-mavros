...
public:
    ...
    HilPlugin() : PluginBase(), hil_nh("~hil") {}
    ...
    void initialize(UAS &uas_) override {
        ...
        hil_actuator_controls_pub =
            hil_nh.advertise<mavros_msgs::HilActuatorControls>("actuator_controls", 10);
    }
...
private:
    ...
    void handle_hil_actuator_controls(
        ...
        hil_actuator_controls_msg->header.stamp =
            m_uas->synchronise_stamp(hil_actuator_controls.time_usec);
    ...
    void state_quat_cb(const mavros_msgs::HilStateQuaternion::ConstPtr &req) {
        ...
        auto ang_vel = ftf::transform_frame_enu_ned(
            ftf::transform_frame_baselink_aircraft(ftf::to_eigen(req->angular_velocity)));
        auto lin_vel =
            ftf::transform_frame_enu_ned<Eigen::Vector3d>(ftf::to_eigen(req->linear_velocity)) *
            1E2;
        // linear acceleration - WRT world frame
        auto lin_acc =
            ftf::transform_frame_baselink_aircraft(ftf::to_eigen(req->linear_acceleration));
    ...
    void sensor_cb(const mavros_msgs::HilSensor::ConstPtr &req) {
        ...
        auto gyro = ftf::transform_frame_baselink_aircraft(ftf::to_eigen(req->gyro));
        auto mag = ftf::transform_frame_baselink_aircraft<Eigen::Vector3d>(ftf::to_eigen(req->mag) *
                                                                           TESLA_TO_GAUSS);
    ...
    void optical_flow_cb(const mavros_msgs::OpticalFlowRad::ConstPtr &req) {
        ...
        auto int_gyro = ftf::transform_frame_aircraft_baselink(
            Eigen::Vector3d(req->integrated_xgyro, req->integrated_ygyro, req->integrated_zgyro));
