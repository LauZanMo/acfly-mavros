...
public:
    ...
    void initialize(UAS &uas_) override {
        ...
        gp_nh.param<std::string>("tf/global_frame_id", tf_global_frame_id,
                                 "earth"); // The global_origin should be represented as "earth"
    ...
    Subscriptions get_subscriptions() override {
        return {make_handler(&GlobalPositionPlugin::handle_gps_raw_int),
...
private:
    ...
    void handle_gps_global_origin(const mavlink::mavlink_message_t *       msg,
        ...
        // auto header = m_uas->synchronized_header(frame_id, glob_orig.time_boot_ms);	#TODO:
