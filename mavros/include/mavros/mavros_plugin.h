...
protected:
    ...
    HandlerInfo make_handler(const mavlink::msgid_t id,
        ...
        auto bfn =
            std::bind(fn, static_cast<_C *>(this), std::placeholders::_1, std::placeholders::_2);
    ...
    inline void enable_connection_cb() {
        m_uas->add_connection_change_handler(
            std::bind(&PluginBase::connection_cb, this, std::placeholders::_1));
    }
    ...
    void enable_capabilities_cb() {
        m_uas->add_capabilities_change_handler(
            std::bind(&PluginBase::capabilities_cb, this, std::placeholders::_1));
    }
};
} // namespace plugin
} // namespace mavros
